...
class HorizonClientSync(BaseClient[OAuth2Session]):
    ...
    def copy_hwms(self, data: HWMCopyRequestV1) -> HWMResponseListV1:
        ...
        Returns
        -------
        :obj:`HWMResponseListV1 <horizon.commons.schemas.v1.hwm.HWMResponseListV1>`
            Copied HWMs
        ...
        >>> copy_data = HWMCopyRequestV1(
        ...     source_namespace_id=123,
        ...     target_namespace_id=456,
        ...     hwm_ids=[1, 2, 3],
        ...     with_history=True,
        ... )
        >>> copied_hwms = client.copy_hwms(data=copy_data)
        ...
        return self._request(  # type: ignore[return-value]
            ...
            json=data.dict(),
            response_class=HWMResponseListV1,
        )
