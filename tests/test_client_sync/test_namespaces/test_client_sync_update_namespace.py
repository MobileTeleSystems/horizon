...
from horizon_commons.schemas.v1 import NamespaceResponseV1, UpdateNamespaceRequestV1
...
def test_sync_client_update_namespace_name(
    ...
    to_update = UpdateNamespaceRequestV1(name=new_namespace.name)
...
def test_sync_client_update_namespace_description(
    ...
    to_update = UpdateNamespaceRequestV1(description=new_namespace.description)
    response = sync_client.update_namespace(namespace.name, to_update)
...
def test_sync_client_update_namespace_missing(new_namespace: Namespace, sync_client: HorizonClientSync):
    to_update = UpdateNamespaceRequestV1(name=new_namespace.name, description=new_namespace.description)
